...
echo -e $red "╔──────────────────────────────────────────────────────────╗"
echo -e $red "|          Evil-Droid Framework $ DARK_ENERGY              |"
...
echo -e $lightgreen "  DarkNET--->hacker & carding forum  "
echo -e $lightgreen "   ШКОЛОЛО НЕ СЛИВАТЬ НА ВТ БЛЕА!!!  "                                
}
#function lhost
function get_lhost() 
{
...
start=$(zenity --question --title="☢ Evil-Droid Framework ☢" --text "Запустить фреймворк?" --width 270 2> /dev/null)
  if [ "$?" -eq "0" ]; then
    ...
    echo -e $lightgreen "|                     Изменен: DARK_ENERGY                          |"
    echo -e $lightgreen "|         Evil-Droid Framework  by DarkNet - теневой интернет       |"
    echo -e $lightgreen "|                                                                   |"
    echo -e $lightgreen "|                     перевод DARK_ENERGY                           |"
    echo -e $lightgreen "┖───────────────────────────────────────────────────────────────────┙"
    echo ""
    apache_svc_stop
    postgresql_stop
...
function main()
{
    ...
    do
        ...
        echo -e $green ""
        echo "╔──────────────────────────────────────────────╗"
        echo "|             Evil-Droid Framework             |"
        echo "|      Взлом удаленного андроид устройства     |"  
             "|          ШКОЛЬНИКИ ИПАНЫЕ ЛЕСОМ ИДИТЕ!       |"
        echo "┖──────────────────────────────────────────────┙"
